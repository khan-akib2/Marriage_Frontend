...
import { sendCustomerRejectionEmail } from "../../../lib/brevo";
...
export async function GET(request) {
  try {
    ...
    // Attempt to update the status to REJECTED
    const result = updateBookingStatus(id, "REJECTED", token);
